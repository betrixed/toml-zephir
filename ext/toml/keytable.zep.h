...
ZEPHIR_INIT_FUNCS(toml_keytable_method_entry) {
	...
	PHP_ME(Toml_KeyTable, getTag, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	PHP_ME(Toml_KeyTable, setTag, arginfo_toml_keytable_settag, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
