...
ZEPHIR_INIT_FUNCS(toml_token_method_entry) {
	PHP_ME(Toml_Token, __construct, NULL, ZEND_ACC_FINAL|ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_ME(Toml_Token, set, arginfo_toml_token_set, ZEND_ACC_FINAL|ZEND_ACC_PUBLIC)
	PHP_FE_END
};
