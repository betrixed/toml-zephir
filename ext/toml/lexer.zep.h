...
ZEND_BEGIN_ARG_INFO_EX(arginfo_toml_lexer_getexpmap, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(toml_lexer_method_entry) {
	PHP_ME(Toml_Lexer, getTomlVersion, NULL, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Toml_Lexer, getUseVersion, NULL, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Toml_Lexer, tokenName, arginfo_toml_lexer_tokenname, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Toml_Lexer, getExpMap, arginfo_toml_lexer_getexpmap, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
