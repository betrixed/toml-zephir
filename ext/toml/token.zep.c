...
ZEPHIR_INIT_CLASS(Toml_Token) {
	...
	ZEPHIR_REGISTER_CLASS(Toml, Token, toml, token, toml_token_method_entry, ZEND_ACC_FINAL_CLASS);

	zend_declare_property_null(toml_token_ce, SL("value"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(toml_token_ce, SL("id"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(toml_token_ce, SL("line"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(toml_token_ce, SL("isSingle"), ZEND_ACC_PUBLIC TSRMLS_CC);
