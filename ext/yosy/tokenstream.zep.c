...
ZEPHIR_INIT_CLASS(Yosy_TokenStream) {
	...
	ZEPHIR_REGISTER_CLASS(Yosy, TokenStream, yosy, tokenstream, yosy_tokenstream_method_entry, 0);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_lines"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_lineCount"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_curLine"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_id"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_value"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_lineNo"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_tokenLine"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_isSingle"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_offset"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_regex"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_singles"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_unknownId"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_newLineId"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_eosId"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_matches"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yosy_tokenstream_ce, SL("_token"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Yosy_TokenStream, __construct) {
	...
	ZEPHIR_INIT_VAR(&_0);
	object_init_ex(&_0, yosy_token_ce);
...
PHP_METHOD(Yosy_TokenStream, setInput) {
	...
	object_init_ex(&boxme, yosy_box_ce);
	ZEPHIR_INIT_VAR(&_0);
	zephir_fast_explode_str(&_0, SL("\n"), &input, LONG_MAX TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, &boxme, "__construct", NULL, 7, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Yosy_TokenStream, setLines) {
	...
	if (ZEPHIR_GT_LONG(&_1, 0)) {
		...
		ZEPHIR_OBS_NVAR(&_2);
		zephir_array_fetch_long(&_2, &_3, 0, PH_NOISY, "yosy/TokenStream.zep", 107 TSRMLS_CC);
	} else {
		ZEPHIR_INIT_NVAR(&_2);
		ZVAL_NULL(&_2);
	}
...
PHP_METHOD(Yosy_TokenStream, moveNextId) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "parsenextid", NULL, 8, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yosy_TokenStream, parseNextId) {
	...
	if (ZEPHIR_IS_EMPTY(&_0)) {
		...
		if (ZEPHIR_LT(&nextLine, &_3$$3)) {
			...
			zephir_array_fetch(&_6$$4, &_5$$4, &nextLine, PH_NOISY | PH_READONLY, "yosy/TokenStream.zep", 140 TSRMLS_CC);
	...
	zephir_is_iterable(&_14, 0, "yosy/TokenStream.zep", 173);
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_14), _16, _17, _15)
	{
		...
		if (zephir_is_true(&_18$$7)) {
			zephir_array_fetch_long(&_20$$8, &matches, 1, PH_NOISY | PH_READONLY, "yosy/TokenStream.zep", 159 TSRMLS_CC);
			...
			zephir_array_fetch_long(&_22$$8, &matches, 1, PH_NOISY | PH_READONLY, "yosy/TokenStream.zep", 164 TSRMLS_CC);
	...
	ZVAL_LONG(&_26, 0);
	ZVAL_LONG(&_27, 1);
	ZEPHIR_CALL_FUNCTION(&uni, "mb_substr", NULL, 9, &_25, &_26, &_27);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&takeoff);
