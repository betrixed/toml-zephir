...
ZEPHIR_INIT_FUNCS(yosy_valuelist_method_entry) {
	...
	PHP_ME(Yosy_ValueList, offsetSet, arginfo_yosy_valuelist_offsetset, ZEND_ACC_PUBLIC)
	PHP_ME(Yosy_ValueList, offsetExists, arginfo_yosy_valuelist_offsetexists, ZEND_ACC_PUBLIC)
	PHP_ME(Yosy_ValueList, offsetGet, arginfo_yosy_valuelist_offsetget, ZEND_ACC_PUBLIC)
	PHP_ME(Yosy_ValueList, offsetUnset, arginfo_yosy_valuelist_offsetunset, ZEND_ACC_PUBLIC)
	PHP_ME(Yosy_ValueList, count, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Yosy_ValueList, get, arginfo_yosy_valuelist_get, ZEND_ACC_PUBLIC)
	PHP_ME(Yosy_ValueList, toArray, arginfo_yosy_valuelist_toarray, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
