...
ZEPHIR_INIT_CLASS(Yosy_XArrayable) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Yosy, XArrayable, yosy, xarrayable, zend_exception_get_default(TSRMLS_C), yosy_xarrayable_method_entry, 0);
...
PHP_METHOD(Yosy_XArrayable, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, yosy_xarrayable_ce, getThis(), "__construct", NULL, 0, &msg);
