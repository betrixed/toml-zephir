...
ZEPHIR_INIT_FUNCS(yosy_arrayable_method_entry) {
	PHP_ME(Yosy_Arrayable, setTag, arginfo_yosy_arrayable_settag, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	PHP_ME(Yosy_Arrayable, getTag, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
